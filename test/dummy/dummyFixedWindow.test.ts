...
import { DummyFixedWindow } from "../../src/dummy/DummyFixedWindow";

describe("DummyFixedWindow", () => {
  let dummyRateLimiter: DummyFixedWindow;

  beforeEach(() => {
    dummyRateLimiter = new DummyFixedWindow();
  });
  ...
  describe("Constructor", () => {
    ...
    it("should not throw errors during construction", () => {
      expect(() => new DummyFixedWindow()).not.toThrow();
    });
  });
